...
async def tambah_nabung(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
async def show_statistik(query):
    ...
    month_stats = {key: value for key, value in status.items() if key.endswith(this_month_key)}
